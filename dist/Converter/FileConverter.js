...
var FileConverter = /** @class */ (function () {
    ...
    /** @inheritdoc */
    FileConverter.prototype.ConvertBlobToFile = function (blob) {
        return {
    ...
    /** @inheritdoc */
    FileConverter.prototype.ConvertFileToBlobFile = function (file, fileReader) {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        fileReader.onload = function () { return __awaiter(_this, void 0, void 0, function () {
                            var b;
                            return __generator(this, function (_a) {
                                b = new BlobFile_1.default(file.type, file.name, file.size);
    ...
    FileConverter.prototype.ConvertStringToBufferArray = function (str) {
        var buffer = new ArrayBuffer(str.length);
        var uInt = new Uint8Array(buffer);
        // tslint:disable-next-line: binary-expression-operand-order
        for (var i = 0; 0 <= str.length ? i < str.length : i > str.length; i = 0 <= str.length ? ++i : --i) {
